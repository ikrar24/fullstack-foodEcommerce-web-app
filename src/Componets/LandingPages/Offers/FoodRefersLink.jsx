...
import Items from "../../HomePages/Items/Items";
...
function FoodReferLink() {
  ...
  const food = itemsData.find(
    (item) => item.FoodName.toLowerCase() === itemName.toLowerCase()
  );

  if (!food) return <h2>Item Not Found</h2>;

  // favs localStorage <script></script>
          ...
          <div className="itemBox">
            ...
            <div className="buyBtnBox addToCartBox">
              <div className="FavIcon">
                <FaHeart
                  className="heartIcon"
                  style={{ color: isFavorited(item.FoodName) ? "red" : "gray" }}
